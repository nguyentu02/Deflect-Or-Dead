            ...
            if (weaponGameObject != null)
            {
                ...
                switch (weaponInstantiateSlot)
                {
                    ...
                    case WeaponInstantiateSlot.BackSlot:
                        ...
                        {
                            weaponGameObject.transform.localPosition = new Vector3
                                (0.212543f, -0.1514575f, -0.4658348f);
                            weaponGameObject.transform.localRotation = Quaternion.Euler
                                (-22.719f, 65.157f, 149.634f);
                        }
                        break;
                    default:
                        break;
